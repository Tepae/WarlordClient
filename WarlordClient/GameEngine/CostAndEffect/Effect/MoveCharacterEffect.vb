...
Namespace GameEngine.CostAndEffect.Effect
    ...
    Public Class MoveCharacterEffect
        ...
        Public Sub Perform(id As Guid, sc As SmallCard, ge As GameEngine, passTurn As Boolean) Implements IEffect.Perform
            _id = id
            Dim cm As New CharacterMover(id, ge, CharacterPlacementDialogFactory.CreateDialogForGenericNonSpendningMovement(ge, sc, ge.CardCollectionOfCardInstance(sc.Card), _range), passTurn)
            cm.MoveCharacter()
        End Sub
